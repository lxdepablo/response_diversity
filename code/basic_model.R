...
# define parameters
n_species <- 10
abundance_intercept_range <- c(0, 1000)
...
total_funct_response_model <- lm(total_function ~ response_diversity, data = model_stats)

sum_sensitivity_resilience_response_model <- lm(log(resilience) ~ response_diversity + sum_sensitivity, data = model_stats)
mean_sensitivity_resilience_response_model <- lm(log(resilience) ~ response_diversity + mean_sensitivity, data = model_stats)

summary(resilience_response_model)
summary(total_funct_response_model)
summary(sum_sensitivity_resilience_response_model)
summary(mean_sensitivity_resilience_response_model)
